...
public class ProductInfo extends FrameworkActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //below code will load product details from configuration.
        TextView view =(TextView) findViewById(R.id.appDetail);
        view.setText(applicationContextData.getValue(ApplicationConstants.PRODUCT_DETAILS));
